...
const
    // this class will be extended but the base classes of both factories
    // to provide objects with the ability to create new elements in the DOM
    domNodeCreator = class {
        ...
        create({tag = null, attributes = null, properties = null, listeners = null}) {
            ...
            if (listeners instanceof Array)
                ...
                listeners.forEach(({event, callback}) => element.addEventListener(event, callback, {
